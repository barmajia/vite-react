...
test.describe('Security Tests', () => {
  ...
  test.describe('CSRF Protection', () => {
    test('should include CSRF token in forms', async ({ page }) => {
      ...
      const csrfToken = await page.locator('input[name*="csrf"]').getAttribute('value');
  ...
  test.describe('Input Validation', () => {
    ...
    test('should enforce password requirements', async ({ page }) => {
      ...
      await expect(page.getByText(/minimum.*character|uppercase|lowercase|number/i)).toBeVisible();
    });
  ...
  test.describe('Error Handling', () => {
    test('should show generic error messages', async ({ page }) => {
      ...
      const errorText = await page.getByText(/error|invalid/i).textContent();
