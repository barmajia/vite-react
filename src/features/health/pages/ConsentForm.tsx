...
import { submitConsentForm } from "@/services/healthService";
...
export const ConsentForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Submit consent form via backend RPC
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Electronic consent for telemedicine consultation
            </p>
          </div>
        </div>
        ...
        <Alert>
          ...
          <AlertDescription>
            This form is protected by HIPAA compliance standards. Your
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Please read and accept all agreements
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    I consent to receive medical consultation and treatment via
                    telemedicine. I understand the benefits and risks of remote
                    medical care.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    I consent to the electronic transmission and storage of my
                    medical information in compliance with HIPAA regulations. I
                    understand my data is protected and will only be used for
                    medical purposes.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    I understand that telemedicine involves video/audio
                    communication and that technical issues may occur. I agree
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Your legal signature for this consent form
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="signature">
                  Type Your Full Name (Legal Signature)
                </Label>
                <Input
                  id="signature"
                  name="signature"
              ...
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span>Date: {format(new Date(), "MMMM d, yyyy h:mm a")}</span>
              </div>
            </CardContent>
          </Card>
