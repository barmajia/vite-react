...
export function SellerHeader({ onToggleSidebar }: SellerHeaderProps) {
  ...
  const navLinks = [
    ...
    { to: "/seller/orders", label: "Orders", icon: TrendingUp },
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to="/seller/signup">
                <button className="h-12 px-6 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] shadow-2xl shadow-emerald-500/30 hover:scale-105 transition-all">
                  Sign Up
                </button>
              </Link>
            </div>
        ...
        <div className="flex justify-between items-center h-16">
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.4em] opacity-60 leading-none mt-1 text-white/80">
                {sellerProfile?.company_name || "Seller Dashboard"}
              </span>
            </div>
          </Link>
