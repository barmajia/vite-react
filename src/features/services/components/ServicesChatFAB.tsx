    ...
    <div className="fixed bottom-10 right-10 z-[200]">
      ...
      >
        <div className="p-8 space-y-6">
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[9px] font-black uppercase tracking-[0.4em] text-primary italic">
                  {t("servicesNexus.fab.nexusLink")}
                </span>
              </div>
              <h2 className="text-2xl font-black italic tracking-tighter uppercase">
                {t("servicesNexus.fab.quickConnect")}{" "}
                <span className="text-foreground/40 italic">Connect</span>
              </h2>
            </div>
            <Button
              variant="ghost"
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3 text-white/20">
              ...
              <span className="text-[8px] font-black uppercase tracking-widest italic">
                {t("servicesNexus.fab.frequentTransmissions")}
              </span>
            </div>
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className="relative">
                      <Avatar
                        name={node.name}
                        className="h-12 w-12 rounded-xl border-2 border-white/5 group-hover:border-primary transition-all shadow-xl"
                      />
                      <div
                        className={cn(
                    ...
                    <div className="text-left">
                      <h4 className="text-xs font-black italic uppercase tracking-tighter group-hover:text-primary transition-colors">
                        {node.name}
                      </h4>
          ...
          <div className="flex items-center justify-center gap-3 opacity-20">
            ...
            <span className="text-[8px] font-black uppercase tracking-widest italic">
              {t("servicesNexus.fab.vaultActive")}
            </span>
          </div>
        </div>
      </div>
      ...
      <button
        ...
        className={cn(
          ...
          isOpen
            ? "bg-white rotate-[-45deg] scale-90"
            : "bg-primary hover:scale-110 hover:shadow-primary/50",
        )}
      >
        ...
        <div className="absolute -top-1 -right-1 w-6 h-6 bg-white text-black text-[10px] font-black rounded-lg flex items-center justify-center shadow-xl transform rotate-12 scale-100 group-hover:scale-110 transition-transform">
          2
        </div>
      </button>
    </div>
