          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-12">
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="text-xl font-black italic tracking-tighter leading-none group-hover:text-primary transition-colors">
                    AURORA
                  </span>
                  ...
                  >
                    <div className="grid grid-cols-2 gap-4">
                      <div className="col-span-1 space-y-4">
                        <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-primary/60 px-2 italic">
                          Standard Nodes
                        </h3>
                        {[
                          {
                          ...
                          >
                            ...
                            >
                              <div
                                className={`p-3 rounded-2xl ${item.bgColor} flex-shrink-0 transition-all duration-500 group-hover:scale-110 shadow-lg group-hover:shadow-primary/20`}
                              >
                                <item.icon
                              ...
                              <div>
                                ...
                                <p className="text-[10px] font-bold text-muted-foreground/60 mt-1 uppercase tracking-tight leading-tight">
                                  {item.desc}
                                </p>
                              </div>
                            </Link>
            ...
            <div className="flex items-center gap-6">
              <form
                ...
                className="hidden lg:relative group lg:block"
              >
                <input
                  type="text"
                  placeholder={
                    t("common.searchProducts") || "INITIATE SEARCH..."
                  }
                  value={searchQuery}
                  ...
                  className={cn(
                    ...
                    isSearchFocused &&
                      "border-primary/40 shadow-[0_0_30px_rgba(59,130,246,0.15)] ring-1 ring-primary/20 bg-white/10",
                  )}
                />
                <Search
                  className={cn(
                ...
                {!isSearchFocused && searchQuery === "" && (
                  <span className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center justify-center h-5 px-1.5 border border-white/10 rounded text-[9px] font-black text-muted-foreground/30 font-mono tracking-tighter">
                    CMD K
                  </span>
                )}
              </form>
                        ...
                        >
                          ...
                          {supportedLanguages.map((lang) => (
                            ...
                            >
                              ...
                              <span className="flex-1 uppercase tracking-tight">
                                {lang.nativeName}
                              </span>
                              {currentLang.code === lang.code && (
                        ...
                        <button className="flex items-center gap-3 glass bg-white/5 border-white/10 hover:bg-white/10 p-2 rounded-2xl transition-all duration-500 group">
                          ...
                          <div className="hidden lg:flex flex-col items-start pr-2">
                            <span className="text-[10px] font-black italic tracking-tight">
                              {user.user_metadata.full_name || "USER_ROOT"}
                            </span>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button
                          variant="ghost"
                          className="glass bg-white/5 border-white/10 h-12 px-6 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-white/10 transition-all active:scale-95 gap-2"
                        >
                          {t("auth.signIn")}
                      ...
                      <DropdownMenuContent
                        align="end"
                        sideOffset={12}
                        className="w-64 glass p-3 rounded-[2rem] shadow-2xl border-white/10 animate-in fade-in zoom-in-95 duration-300"
                      >
                        ...
                        <DropdownMenuItem
                          ...
                          className="rounded-xl p-3 mb-1 cursor-pointer transition-all duration-300 gap-3"
                        >
                        ...
                        <DropdownMenuItem
                          onClick={() => navigate("/middleman/login")}
                          className="rounded-xl p-3 mb-1 cursor-pointer transition-all duration-300 gap-3"
                        >
                        ...
                        <DropdownMenuItem
                          ...
                          className="rounded-xl p-3 cursor-pointer transition-all duration-300 gap-3"
                        >
                          <Truck className="h-4 w-4 text-violet-500" />
                          <div className="flex-1">
                            <p className="text-xs font-bold italic">Delivery</p>
                            <p className="text-[9px] text-muted-foreground/60 uppercase tracking-tight">
                              Delivery ops
                            </p>
                          </div>
                    ...
                    {/* Signup Button - Customer Only */}
                    <button
                      onClick={() => navigate(ROUTES.SIGNUP)}
                      className="h-12 px-6 bg-primary text-white rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] shadow-2xl shadow-primary/30 hover:scale-105 active:scale-95 transition-all relative overflow-hidden group"
                    >
                      ...
                      <span className="relative z-10">{t("auth.joinNow")}</span>
                    </button>
                  </div>
                )}
