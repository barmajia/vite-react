            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  type="email"
                  required
                  className="pl-12 h-14 glass bg-white/5 border-white/10 rounded-2xl focus:ring-emerald-500/50 transition-all text-lg placeholder:text-muted-foreground/30"
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  required
                  className="pl-12 pr-12 h-14 glass bg-white/5 border-white/10 rounded-2xl focus:ring-emerald-500/50 transition-all text-lg placeholder:text-muted-foreground/30"
