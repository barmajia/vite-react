...
export function FactoryLogin() {
      ...
      if (error) {
        ...
        if (data?.user) {
          ...
          if (seller.status === "pending_review") {
            toast.info("Your factory account is pending review");
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      {/* Background Elements */}
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-blue-500/20 rounded-full blur-[120px] animate-pulse pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-indigo-500/10 rounded-full blur-[120px] pulse pointer-events-none" />
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  type="email"
                  required
                  className="pl-12 h-14 glass bg-white/5 border-white/10 rounded-2xl focus:ring-blue-500/50 transition-all text-lg placeholder:text-muted-foreground/30"
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  required
                  className="pl-12 pr-12 h-14 glass bg-white/5 border-white/10 rounded-2xl focus:ring-blue-500/50 transition-all text-lg placeholder:text-muted-foreground/30"
