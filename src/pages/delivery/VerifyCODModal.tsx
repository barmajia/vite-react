...
export default function VerifyCODModal({ order, onClose, onSuccess }: VerifyCODModalProps) {
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="bg-yellow-50 p-3 rounded-lg flex items-start gap-2 border border-yellow-200">
            ...
            <p className="text-sm text-yellow-800">
              Only verify after receiving cash payment from customer.
              This action cannot be undone.
            </p>
          </div>

          {/* Success Preview */}
          {enteredCode.toUpperCase() === order.verification_key.toUpperCase() && locationVerified && (
          ...
          <div className="flex gap-2 pt-2">
            <Button
              ...
              disabled={verifying || !locationVerified || enteredCode.length < 6}
              className="flex-1"
            >
