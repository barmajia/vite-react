                    ...
                    {order.shipping_address_snapshot && (
                      <div className="bg-gray-50 p-3 rounded-lg">
                        ...
                        <p className="text-sm">
                          ...
                          {order.shipping_address_snapshot.city && `, ${order.shipping_address_snapshot.city}`}
                          {order.shipping_address_snapshot.state && `, ${order.shipping_address_snapshot.state}`}
                        </p>
                      </div>
                    )}

                    {/* Verification Code (if COD and not delivered) */}
                    {order.verification_code && order.status !== 'delivered' && (
                      <div className="bg-blue-50 p-3 rounded-lg border border-blue-200">
                        ...
                        <p className="text-xs text-blue-600 mt-1">
                          Share this code with the delivery driver after payment
                        </p>
                      </div>
                    )}
                  </CardContent>
